...
"""procesamiento_data_coment (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1F1h8uRdMWdHn_gCc7Sp0pKZM7TLFce1K

# <center>  PIPELINE PROYECTO ANALISIS VENTAS DE VIDEOJUEGOS </center>
<hr>

La base de datos que cargamos inicialmente contiene informacion sobre las ventas de videojuegos en diferentes regiones. A continuacion mostramos el analisis de ventas globales y las diferentes tendencias encontradas segun los datos dados.
...
"""Vemos el tipo de información que quedo almacenada y si el cambio de variables se dio satisfactoriamente."""
...
"""Esta tabla muestra la agrupación por colunma editorial eliminando el total y agrupandola nuevamente para ver el resultado.
...
"""Revisamos nuevamente que no haya datos faltantes y procedemos al siguiente paso."""
